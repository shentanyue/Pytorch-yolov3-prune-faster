...
class trt_yolo3_module(BaseModule):
    def __init__(self, init_dict):
        ...
        self.inp_dim = 416
        self.num_classes = 80
        self.output_shapes = [(4, 255, 13, 13), (4, 255, 26, 26), (4, 255, 52, 52)] #yolo3-608
    ...
    def detection(self,procession_tuple):
        ...
        if 1:
            ...
            for output, shape, anchors in zip(trt_outputs, self.output_shapes, self.yolo_anchors):
                ...
                # print(type(output))
                # print(len(output))
                trt_output = torch.from_numpy(output).float().cuda().data
            ...
            dets = dynamic_write_results(detections, 0.25, self.num_classes, nms=True, nms_conf=0.45)
            o_time2 = time.time()
...
if __name__ == '__main__':
    init_dict = {'trt':"yolov3-416.trt", 'use_cuda':True}
