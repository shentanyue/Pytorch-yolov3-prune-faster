...
def train(
    ...
    device = torch_utils.select_device(cuda_num=8)
    ...
    for epoch in range(epochs):
        ...
        model.save_weights("%s/%s/yolov3_sparsity_%d.weights" % ('prune_refine','percent_20',epoch))
        print("save weights in %s/%s/yolov3_sparsity_%d.weights" % ('prune_refine','percent_20',epoch))
