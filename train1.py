...
def train(
    ...
    device = torch_utils.select_device(cuda_num=9)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='prune_cfg/prune_0.1_yolov3.cfg', help='cfg file path')
    parser.add_argument('--weights-path', type=str, default='prune_weights/prune_0.1_yolov3_sparsity_95.weights',
